...
//        profile = "/home/jiafan1/.mozilla/firefox/820j3ca9.default"
    ...
    connector{
        ...
        //should in full class name, for instance, "org.telluriumsource.org.telluriumsource.test.MyCommand"
        customClass = ""
    ...
    test{
        ...
        //we may add the result report for regular tellurium org.telluriumsource.test case
        result{
            //specify what result reporter used for the org.telluriumsource.test result
            ...
            output = "Console"
            //org.telluriumsource.test result output file name
        ...
        exception{
            ...
            //we do not care the org.telluriumsource.test logic errors here
